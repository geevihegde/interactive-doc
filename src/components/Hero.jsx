        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Revolutionary piSignage feature that allows you to interact with your screen in real-time.
              </p>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                <div className="absolute -top-px left-20 right-11 h-px bg-gradient-to-r from-sky-300/0 via-sky-300/70 to-sky-300/0" />
                <div className="absolute -bottom-px left-11 right-20 h-px bg-gradient-to-r from-blue-400/0 via-blue-400 to-blue-400/0" />
                  
                  <div className=" flex items-start text-sm">
                    <Image src={p10} className='h-[350px] rounded-3xl'  alt='Image' />
                  </div>
              </div>
            </div>
          </div>
